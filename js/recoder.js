(function (window) {
    ...
    var HZRecorder = function (stream, config) {  
        ...
        config.sampleRate = config.sampleRate || (48000);   //采样率(1/6 44100)
        ...
        var audioData = {  
            size: 0          //录音文件长度  
            , buffer: []     //录音缓存  
            , inputSampleRate: context.sampleRate    //输入采样率context.sampleRate
    ...
    HZRecorder.get = function (callback, config) {  
        ...
        if (callback) {  
            if (navigator.getUserMedia) {  
                ...
                HZRecorder.throwError('浏览器不支持录音功能。'); return;
            }  
        }  
    };  
